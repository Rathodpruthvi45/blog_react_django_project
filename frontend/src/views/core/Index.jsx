...
import Toast from "../../plugin/Moment"
...
function Index() {
    ...
    const fetchPosts=async()=>{
        try {
            const responses_post= await apiInstance.get(`post/lists/`);
            const responses_category =await apiInstance.get(`post/category/list/`);
            setPosts(responses_post.data);
            setCategory(responses_category.data);
        } catch (error) {
            console.log(error);
          ...
          <div className="container">
            ...
            <nav className="d-flex mt-2">
              <ul className="pagination">
                <li
                  className={`page-item ${currentPage === 1 ? "disablled" : ""}`}
                >
                  <button
              ...
              <ul className="pagination">
                <li
                  className={`page-item ${currentPage === totalPages ? "disablled" : ""}`}
                >
                    ...
                    <div className="mt-2">
                      <div className="card bg-transparent">
                        <img
                          ...
                          src={
                            cates?.image ||
                            "https://awcdn1.ahmad.works/writing/wp-content/uploads/2015/05/father-son-1.jpg"
                          }
                          style={{
                            width: "150px",
                            height: "80px",
                        ...
                        <div className="d-flex flex-column align-items-center mt-3 pb-2">
                          <h5 className="mb-0">{cates.title}</h5>
